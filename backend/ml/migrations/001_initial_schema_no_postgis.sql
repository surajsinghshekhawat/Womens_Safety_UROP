...
-- PostgreSQL WITHOUT PostGIS (simplified version)
-- Use this if PostGIS is not installed

-- Incidents Table (without PostGIS geography type)
...
CREATE INDEX IF NOT EXISTS idx_zones_lat_lng ON unsafe_zones(center_lat, center_lng);
